const promptSyncing = require('prompt-sync')();

const balance = promptSyncing("What is your Balance: ");
const minBalance = promptSyncing("What is your min balance: ");
const maxBalance = promptSyncing("What is your max balance: ");

let total: number = parseInt(balance) + parseInt(minBalance) + parseInt(maxBalance);
