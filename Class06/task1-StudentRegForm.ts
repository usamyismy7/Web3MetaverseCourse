...
(async () => {
  ...
  inquirer
    ...
    .then((answers: any) => {
      ...
      console.log(
        chalk.bgBlueBright.greenBright.italic("Gender: ") + student.gender
      );
      console.log(chalk.bgRedBright.yellowBright.underline("Education: "));
      console.log(
        chalk.bgYellowBright.black("Matric: ") + student.education.matric
      );
      console.log(
        chalk.bgYellowBright.black("Intermediate: ") +
          student.education.intermediate
      );
      console.log(
        chalk.bgYellowBright.black("Bachelors: ") + student.education.bachelors
      );
      console.log(
        chalk.bgYellowBright.black("Masters: ") + student.education.masters
      );
    });
})();
